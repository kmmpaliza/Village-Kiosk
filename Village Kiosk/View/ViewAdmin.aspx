       ...
       AllowPaging="True" PageSize="15"  DataKeyNames="AdminId" 
        ...
        <RowStyle HorizontalAlign="Center" Height = "40px" />
         ...
         <Columns>
            ...
            <asp:TemplateField> <ItemTemplate> <asp:ImageButton runat="server" OnClick="btnDelete_Click" ID="btnDelImage" CommandName="DelValue" ImageUrl="~/Images/btnTrash.png" Width="20px" Height="20px" /> </ItemTemplate></asp:TemplateField>
