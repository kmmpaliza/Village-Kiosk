<%@ Page Title="" Language="C#" MasterPageFile="~/Master/VillageMaster.Master" AutoEventWireup="true" CodeBehind="EditAdmin.aspx.cs" Inherits="Village_Kiosk.View.EditAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
<br />

<div align="center">
 <h3 style="color: #ffffff; font-size:65px"><font color= "#D4AF37"><i class="fa fa-user"></i></font> EDIT ADMIN</h3>
    ...
    <div align="center">
         ...
         <asp:RequiredFieldValidator 
          ...
          <asp:TextBox ID="txtname" runat="server" AutoPostBack="true" 
              ...
              ontextchanged="Fullname_Changed" ></asp:TextBox>
          <asp:RequiredFieldValidator 
          ...
          <asp:TextBox ID="txtusername" Enabled="false" runat="server" CssClass="w3-input w3-border w3-margin-bottom" style="text-align:center; border-color:#000080" Width="600px" placeholder = "Last Name & Number"></asp:TextBox>
          ...
          <asp:TextBox ID="txtAnswer" runat="server" CssClass="w3-input w3-border w3-margin-bottom" style="text-align:center; border-color:#000080" Width="600px" placeholder = "Please Enter Your Answer"></asp:TextBox>
          ...
          <asp:Button ID="btnAdmin" runat="server" Text="UPDATE" CssClass="w3-button w3-block w3-hover-khaki w3-round-xlarge w3-section w3-padding" OnClick="btnUpdate_Click" Width="200px" style="background-color: white ; color: red;font-size: 15px; font-family: Trebuchet MS;" />
